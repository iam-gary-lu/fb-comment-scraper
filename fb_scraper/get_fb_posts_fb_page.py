...
page_id=input("Enter fb PageID (ie cnn or nytimes or foxnews ect): ")
#page_id = "nytimes"
...
file_name = page_id+ "" +current_time
...
def scrapeFacebookPageFeedStatus(page_id, access_token, file_name):
    with open('{}_facebook_statuses.csv'.format(file_name), 'w') as file:
        w = csv.writer(file)
...
if __name__ == '__main__':
    scrapeFacebookPageFeedStatus(page_id, access_token, file_name)
